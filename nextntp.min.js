...
try {
    void 0 === window.chrome.embeddedSearch &&
        (console.log(
            'Oh , looks like window.chrome.embeddedSearch is undefined'
        ),
        (window.chrome = {
            embeddedSearch: { newTabPage: { isIncognito: !1 } }
        }),
        (newsServer =
...
function reset_page() {
    confirm('This will reset NTP back to default, are you sure ?') &&
...
function wait(ms) {
    ...
    for (; end < start + ms; ) end = new Date().getTime()
}
function customInner(oldDiv, html) {
    var newDiv = oldDiv.cloneNode(!1)
    ;(newDiv.innerHTML = html), oldDiv.parentNode.replaceChild(newDiv, oldDiv)
}
function alert(options) {
    var t = this
    ;(t.count = 0),
        (t.timeout = options.timeout ? options.timeout : 3e3),
        (t.autoClose =
            !options.hasOwnProperty('autoClose') || options.autoClose)
    const close =
    ...
    ;(t.container = document.querySelector('#nt1')),
        ...
        (t.createItem = function (message, color) {
            ...
            item.classList.add('notify-item'), item.classList.add(color)
        ...
        (t.show = function (l) {
            console.log(t.autoClose),
                t.autoClose && t.setAutocloseTimeout(l, t.timeout),
                t.setCloseOnClick(l),
...
function adaptColor(selector, color) {
    ...
    ;(r = parseInt(result[1], 16)),
        ...
        Math.sqrt(r * r * 0.299 + g * g * 0.587 + b * b * 0.114) > 127.5
    ...
    if (link) {
        const navigate = (id) => {
            var activePage = document.querySelector('section.page-active'),
                activeLink = document.querySelector('[topage].active')
            activePage && activePage.classList.remove('page-active'),
                activeLink && activeLink.classList.remove('active')
            var nextPage = document.querySelector(id),
                nextLink = document.querySelector("[topage='" + id + "']")
            nextPage && nextPage.classList.add('page-active'),
                nextLink && nextLink.classList.add('active')
        }
...
function modal(id) {
    var t = this
    ;(t.m = document.querySelector(id || '.modal')),
        t.m &&
        ...
        (t.toggle = () => {
            t.m.toggle('_show-modal'), t.bdy.toggle('_overflowhidden')
        }),
        (t.show = function () {
            t.bdy.add('_overflowhidden'), t.m.classList.add('_show-modal')
        }),
        (t.hide = function () {
            t.m.classList.remove('_show-modal'), t.bdy.remove('_overflowhidden')
        }),
                    ...
                    do {
                        if (
                            ...
                            ;(a -= h.top + parseInt(P(i, 'border-top-width'))),
                                (l -=
                                    h.left +
                                    parseInt(P(i, 'border-left-width'))),
                                (s = a + r.height),
                                (c = l + r.width)
                            break
                        }
        ...
        function Xt(t) {
            if (q) {
                ...
                var e =
                    ...
                    Et.some(function (t) {
                        var e
                        if ((e = t[j].options.emptyInsertThreshold) && !Y(t)) {
                            var n = k(t),
        ...
        xt &&
            ...
            (Bt.prototype = {
                ...
                _onTouchMove: function (t) {
                    if (st) {
                        var e,
                            n = (e = this.options).fallbackTolerance,
                            o = e.fallbackOffset,
                ...
                sort: function (t, e) {
                    ...
                    this.toArray().forEach(function (t, e) {
                        N((e = o.children[e]), this.options.draggable, o, !1) &&
                            (n[t] = e)
                    }, this),
            ...
            (Bt.mount = function () {
                ...
                ;(e = e[0].constructor === Array ? e[0] : e).forEach(
                    function (t) {
                        ...
                        t.utils && (Bt.utils = A(A({}, Bt.utils), t.utils)),
                            K.mount(t)
                    }
                )
            }),
            ...
            (oe.prototype = {
                onSpill: function (t) {
                    var e = t.dragEl,
                        t
                    ;(t =
                        t.putSortable || this.sortable).captureAnimationState(),
    ...
    (function (e, t) {
        ...
        ;(w.parse = function (e) {
            ...
            (w.fromString = function (e) {
                var t = e.split(') '),
                    i = t[0]
                        .substring(q.globals.translate.length + 1)
                        .split(','),
                ...
                this.options.enableZoom &&
                    function () {
                        ...
                        d(t, 'cr-slider-wrap'),
                            ...
                            (i.step = '0.0001'),
                            (i.value = 1),
                            (i.style.display = e.options.showZoomer
                                ? ''
                                : 'none'),
                    ...
                    function () {
                        ...
                        function m(a) {
                            if (
                                ...
                                var s =
                                    l.elements.overlay.getBoundingClientRect()
                                if (
                                    ((u = !0),
                                    (t = a.pageX),
                                    (i = a.pageY),
                ...
                this.data.points.length
                    ? function (e) {
                          ...
                          var n = e[2] - e[0],
                              ...
                              r =
                                  this.elements.boundary.getBoundingClientRect(),
        ...
        function q(e, t) {
            ...
            if (
                ...
                var i = this.element
                d(i, 'cr-original-image'),
                    m(i, { 'aria-hidden': 'true', alt: '' })
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            return (
                                ...
                                (this._domCancel = v(
                                    '.picker_cancel button',
                                    t
                                )),
                                t.classList.add(
                                    'layout_' + this.settings.layout
                                ),
                                this.settings.alpha ||
                                    t.classList.add('no_alpha'),
...
const safeData = [
    ...
    safeDataT = ['theme', 'ntp_bdy', 'ntp_mtc']
function is_td() {
    try {
...
;(document.getElementById('export-data').onclick = function () {
    ...
    Object.keys(localStorage).forEach((key) => {
        safeData.includes(key) &&
            (console.log(key), (dataStr[key] = localStorage.getItem(key)))
    })
    var dataUri =
    ...
    (document.getElementById('import-data').onchange = function () {
        ...
        ;(reader.onload = function (progressEvent) {
            ...
            Object.keys(data).forEach((key) => {
                safeData.includes(key) ? console.log(key) : delete data[key]
            }),
    ...
    (document.getElementById('import-theme').onchange = function () {
        ...
        ;(reader.onload = function (progressEvent) {
            var str = this.result,
                data = JSON.parse(str)
            Object.keys(data).forEach((key) => {
                safeDataT.includes(key) ? console.log(key) : delete data[key]
            }),
                console.log(data),
                Object.assign(localStorage, data),
                console.log(localStorage),
...
var mLstnr = ['touchmove', 'touchend', 'touchstart'],
    wcentp
isTD || (mLstnr = ['mousemove', 'mouseup', 'mousedown'])
try {
...
if (wcentp) {
    ...
    ;(document.getElementById('sett_mtc').style.background =
        ...
        (localStorage.ntp_ver == ntp_ver && localStorage.ntp_ver) ||
            (localStorage.clear(), (localStorage.ntp_ver = ntp_ver))
    var ntoast = new alert({ timeout: 2e3 })
    function f_dwdg(i) {
        var chd
        switch (i) {
            case 0:
                chd =
                    '<div id="sb_r"><img id="sb_logo" alt=""><div class="sb_wrap"><span id="sb_icon_default"></span><ul id="sb_icon_menu"> </ul><input name="sb_input" type="text" id="sb_input" size="50" spellcheck="false" ></div></div>'
                break
            case 1:
                chd =
    ...
    null == ntp_wdg &&
        ...
        (ntp_wdg = [
            { name: 'Search Bar', cached: f_dwdg(0) },
            { name: 'Tiles Grid', cached: f_dwdg(1) },
            { name: 'News Section', cached: f_dwdg(2) }
        ]),
    ...
    function load_widgets() {
        ...
        for (let z = 0; z < 3; z++) {
            let y = ntp_sett.order[z],
                status = ntp_sett.status[z],
                wdgn = document.getElementById('wdg_' + y),
                c = ''
            status
                ? ((wdgn.style.display = 'block'),
                  (c = 'checked'),
                  'Search Bar' == ntp_wdg[z].name && (wdgn.style.zIndex = '1'),
                  customInner(wdgn, ntp_wdg[z].cached))
                : ((wdgn.style.display = 'none'), customInner(wdgn, '...')),
                0 == orderListChanged &&
                    ...
                    customInner(
                        ...
                        '<svg class="_icon stt_lwoh" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 3a1 1 0 01.707.293l3 3a1 1 0 01-1.414 1.414L10 5.414 7.707 7.707a1 1 0 01-1.414-1.414l3-3A1 1 0 0110 3zm-3.707 9.293a1 1 0 011.414 0L10 14.586l2.293-2.293a1 1 0 011.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>' +
                            ntp_wdg[z].name +
                            '</label><input class="toggle" type="checkbox" id="tgw_' +
                            y +
                            '" ' +
                            c +
                            '/>'
        ...
        for (; paras[0]; ) paras[0].parentNode.removeChild(paras[0])
    }
    null == ntp_sett &&
        (console.log("ntp_sett is undefined , let's create default one"),
        (ntp_sett = { order: [0, 1, 2], status: [1, 1, 1] }),
        localStore('ntp_sett', ntp_sett)),
        theme()
    const dlg_st = new modal('#dlg_st'),
        cl_vn = new modal('#cl_vn'),
        lrt = new modal('#lrt'),
        lrt_fl = new modal('#lrt_fl')
    new pagesRoute(), load_widgets(), ntp_bdy.classList.toggle('op')
    for (var i = 0; i < 6; i++) {
        var a = document.getElementById('stt_opt' + i),
            b = getComputedStyle(ntp_bdy).getPropertyValue('--o' + i)
        if (2 == i)
            for (
                var ar = document.getElementsByClassName('tile_target'), z = 0;
                z < ar.length;
                z++
            )
                ar[z].target = b
        f_trim(a.value.toString()) == f_trim(b.toString())
            ? (a.checked = !0)
            : (a.checked = !1)
    }
    function set_option_t(t, f, i) {
        ...
        ntp_bdy.style.setProperty('--o' + i, value),
            2 == i &&
                setTileTarget('_self' == targetBlank ? '_blank' : '_self'),
            save_ntpbdy()
    }
    document.getElementById('stt_opt0').addEventListener('click', function () {
        ...
        document
            .getElementById('stt_opt1')
            .addEventListener('click', function () {
                set_option_t(this, ' ', 1)
            }),
        document
            .getElementById('stt_opt4')
            .addEventListener('click', function () {
                set_option_t(this, 'auto', 4)
            }),
        document
            .getElementById('stt_opt5')
            .addEventListener('click', function () {
                set_option_t(this, 'inline-block', 5)
            }),
        document
            .getElementById('stt_opt3')
            .addEventListener('click', function () {
    ...
    const fs_value =
        ...
        font_selector = document.getElementById('font-selector'),
        default_f =
    ...
    function f_update_font() {
        ...
        'Default' == font && (font = default_f),
            ntp_bdy.style.setProperty('--custom-font', font),
            save_ntpbdy(),
            console.log(font)
    }
    ;(font_selector.value = fs_value),
        font_selector.value.length < 5 && (font_selector.value = 'Default'),
        console.log(
            '|' +
                getComputedStyle(ntp_bdy).getPropertyValue('--custom-font') +
                '|'
    ...
    var se_data_icons = {
        ...
        ntp_sb = localGet('ntp_sb')
    function render_se_list() {
        var se_keys = Object.keys(ntp_sb.se),
            se_custom_keys
        Object.keys(ntp_sb.custom_se).forEach((el, index) => {
            se_keys.includes(el) || delete ntp_sb.custom_se[el]
        }),
            Object.keys(se_data_icons).forEach((el, index) => {
                se_keys.includes(el) || (ntp_sb.se[el] = !1)
            }),
            se_keys.length != Object.keys(ntp_sb.se) &&
        ...
        se_keys.forEach((el, index) => {
            ...
            if (null != se_icon) {
                var setChecked = 1 == se_status ? 'checked' : '',
                    li = document.createElement('li'),
                    noshadow = ''
                '#ffffff' == se_icon[0] && (noshadow = 'box-shadow:none;'),
                    (li.innerHTML =
                        ...
                        '</span>' +
                        el +
                        '</div><input class="toggle" type="checkbox" id="tg_se' +
                        el +
                        '" ' +
                        setChecked +
                        ' />'),
                ...
                ((se_custom = ntp_sb.custom_se[el]), null != se_custom)
            ) {
                var setChecked = 1 == se_status ? 'checked' : '',
                    li
                ;((li = document.createElement('li')).innerHTML =
                    '<svg class="_icon stt_selisth" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 3a1 1 0 01.707.293l3 3a1 1 0 01-1.414 1.414L10 5.414 7.707 7.707a1 1 0 01-1.414-1.414l3-3A1 1 0 0110 3zm-3.707 9.293a1 1 0 011.414 0L10 14.586l2.293-2.293a1 1 0 011.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg><div class="sb_item"><span class="sb_icon" style="background: ' +
                    se_custom[0] +
                    ' "> ' +
                    se_custom[1] +
                    ...
                    el +
                    '\')" class="_icon" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clip-rule="evenodd"></path></svg><input class="toggle" type="checkbox" id="tg_se' +
                    el +
                    '" ' +
                    setChecked +
                    ' />'),
    ...
    function f_trim(s) {
        return (s = (s = (s = s.replace(/(^\s*)|(\s*$)/gi, '')).replace(
            /[ ]{2,}/gi,
            ' '
        )).replace(/\n /, '\n'))
    }
    ;(null != ntp_sb && null != ntp_sb.se && null != ntp_sb.placeholder) ||
        ((ntp_sb = {
            se: {
                Google: !0,
                Bing: !0,
            ...
            custom_se: { MySearch: ['#000'] }
        }),
        localStore('ntp_sb', ntp_sb)),
        sb_custom_form.addEventListener('submit', (e) => {
            var name = f_trim(document.getElementById('custom_sb_name').value),
                query = f_trim(
                    document.getElementById('custom_sb_query').value
                ),
                color = f_trim(
                    document.getElementById('custom_sb_color').value
                ),
                svg = document.getElementById('custom_sb_svg').value
            return (
                name.length < 1 &&
                query.length < 1 &&
                color.length < 1 &&
                svg.length < 1
                    ? ntoast.error(
                          'You need to complete all the rquired fields '
                      )
                    : ((ntp_sb.se[name] = !0),
            ...
            onEnd: function (evt) {
                for (
                    ...
                    var a = list[z].innerText,
                        s = list[z].querySelector('input').checked
                    se_list[a] = s
                }
                ;(ntp_sb.se = se_list),
                    console.log(ntp_sb),
    ...
    const tms_r0 = document.getElementById('tms_r0'),
        tms_r0v = document.getElementById('tms_r0v'),
        tms_r1 = document.getElementById('tms_r1'),
        tms_r1v = document.getElementById('tms_r1v'),
        tms_r2 = document.getElementById('tms_r2'),
        tms_r2v = document.getElementById('tms_r2v')
    var tms_0 = parseInt(
    ...
    const tg_r5 = document.getElementById('tg_r5'),
        tg_r5vs = document.getElementById('tg_r5v')
    var tg_r5v = parseInt(
    ...
    const tg_r7 = document.getElementById('tg_r7'),
        tg_r7vs = document.getElementById('tg_r7v')
    var tg_r7v = parseInt(
    ...
    const tg_r8 = document.getElementById('tg_r8'),
        tg_r8vs = document.getElementById('tg_r8v')
    var tg_r8v = parseInt(
    ...
    const tg_r6 = document.getElementById('tg_r6'),
        tg_r6vs = document.getElementById('tg_r6v')
    var tg_r6v = parseInt(
    ...
    const sb_logo = document.getElementById('sb_logo'),
        sett_sblgp = document.getElementById('sb_lgp'),
        sett_sb_lgf = document.getElementById('sb_lgf')
    function f_sb_lg1() {
    ...
    if (
        ...
        const sb_dropdown_menu = document.getElementById('sb_icon_menu'),
            sb_icon_default = document.getElementById('sb_icon_default'),
            sb_custom_form = document.getElementById('sb_custom_form')
        function f_cache_sb() {
            const y = ntp_sett.order[0]
            ;(ntp_wdg[0].cached = document.getElementById(
                'wdg_' + y
            ).innerHTML),
        ...
        function f_setup_sb() {
            ...
            document
                ...
                Object.keys(ntp_sb.se).forEach((el, index) => {
                    ...
                    var se_icon = se_data_icons[el]
                    if (
                        (null == se_icon && (se_icon = ntp_sb.custom_se[el]),
                        null != se_icon && se_status)
                    ) {
                        var si = document.createElement('li')
                        si.setAttribute('data-se', el),
                            si.addEventListener('click', (event) => {
                                var q =
                                    sb_dropdown_menu.querySelector(
                                        'li.active_sb'
                                    )
                                null != q && q.classList.remove('active_sb'),
                            ...
                            0 == index &&
                                ((document.getElementById(
                                    'sb_input'
                                ).placeholder = ntp_sb.placeholder + ' ' + el),
        ...
        function search(text) {
            ...
            var query = se_data_query[key],
                sei
            null == query && (query = ntp_sb.custom_se[key][2])
    ...
    if (ntp_sett.status[1]) {
        ...
        const p_tile = document.getElementById('p_tile'),
            i_url = document.getElementById('i_url'),
            fi_url = document.getElementById('fi_url'),
            t_ac = document.getElementById('t_ac'),
            t_url = document.getElementById('t_url'),
            t_lab = document.getElementById('t_lab'),
            ft_lab = document.getElementById('ft_lab'),
            dlg = new modal('#dlg'),
            dlg_fl = document.getElementById('dlg_fl'),
            dlg_tg = document.getElementById('dlg_tg'),
            b_save = document.getElementById('b_save'),
            b_add = document.getElementById('b_add'),
            b_save2 = document.getElementById('b_save2'),
            b_add2 = document.getElementById('b_add2'),
            fldb = document.getElementById('lrt_bfl')
        var fld_current
        function setTileTarget(value) {
            for (
                var ar = document.getElementsByClassName('tile_target'), i = 0;
                i < ar.length;
                i++
            )
                ar[i].target = value
            ;(targetBlank = value), f_cache_tl()
        }
        function f_cache_tl() {
            if (
                void 0 === localStorage.cachedGridUpdate ||
                Date.now() / 1e3 - localStorage.cachedGridUpdate >= 0.1
            ) {
                var y = ntp_sett.order[1]
                ;(ntp_wdg[1].cached = document.getElementById(
                    'wdg_' + y
                ).innerHTML),
                    (localStorage.cachedGridUpdate = Date.now() / 1e3),
                    console.log(
        ...
        function f_cnt() {
            ...
            '' == title && (title = get_root_domain(newt.url)),
                (newt.title = title),
        ...
        function f_sptt(t) {
            i_url.disabled &&
                ...
                (timeoutVariable = setTimeout(function () {
                    ...
                    ;(p_tile.src = iUrl), (i_url.value = iUrl)
                }, 1e3)))
        }
        function f_spti(t) {
            window.clearTimeout(timeoutVariable),
        ...
        function f_sedt() {
            ...
            f_cache_tl(), f_dlg_close()
        }
        function f_gfi() {
            var url = i_url.value
            url[30] && (p_tile.src = url + '?fallback=1')
        }
        function f_iimg(item) {
            var parser
            ;(document.createElement('a').href = t_url.value),
        ...
        function f_attg(item) {
            ...
            ;(innerDiv.className = 'tlg_item'),
                (innerDiv.innerHTML =
                    ...
                    '" ' +
                    targetBlank +
                    ' rel="noreferrer"><img class="tlg_img" src="' +
                    item.imgSrc +
        ...
        function f_ofld(el) {
            var tls = (fld_current = el.querySelector('.tlg_fld')).innerHTML
            ;(fldb.innerHTML = tls), lrt_fl.show()
        }
        function f_tggl_f() {
            ...
            fldT.option('disabled', !state),
                (document.getElementById('fld_editA').style.display = state
                    ...
                    : 'none'),
                state ||
                    ((fld_current.innerHTML = fldb.innerHTML), f_cache_tl())
        }
        function f_tggl_t() {
            ...
            gridT.option('disabled', !state),
                ...
                (document.getElementById('tlg_editA').style.display = state
                    ? 'flex'
                    : 'none'),
                state || (f_cache_tl(), save_ntpbdy())
        }
        function f_evl_gtiles() {
            var currentFolder = null,
                folders = document.querySelectorAll('.folder:not(.np)')
            Array.from(folders).forEach((e) => {
                ...
                (document.getElementById('tlg').oncontextmenu = function (e) {
                    e.preventDefault(), f_tggl_t()
                }),
                (document.getElementById('lrt_bfl').oncontextmenu = function (
                    e
                ) {
                    e.preventDefault(), f_tggl_f()
                }),
                lrt_fl.m.addEventListener('click', function (e) {
                    e.target == this && (e.preventDefault(), f_tggl_f())
                })
        }
        function f_setup_sldr() {
            ...
            function set_tg_r2() {
                for (
                    var tCol = parseInt(ntp_tlg.n),
                        tWidth = parseInt(ntp_tlg.w),
                        tMargin = 10,
                        calc = tCol * (tWidth + 10) + 1;
                    calc > wid;

                )
                    (calc = (tCol -= 1) * (tWidth + 10) + 1),
                        console.log(wid + ' . - ' + calc)
                ;(ntp_tlg.n = tCol), (ntp_tlg.m = 10), setTLG()
            }
            function set_tg_r1() {
                for (
            ...
            isNaN(ntp_tlg.w) &&
                ((ntp_tlg = { w: 64, m: 10, n: f_gncols(), r: 32 }), setTLG()),
                (tg_r1.value = ntp_tlg.n),
        ...
        function process_body_click(e) {
            if (e.target == document.getElementById('sld_tg'))
                return (
                    document
                        .getElementById('sld_vw')
                        .classList.toggle('open_sld'),
                    void e.preventDefault()
                )
            e.target != document.getElementById('tlg_sldr')
                ? (gridT.option('disabled') ||
                      (document
                          .getElementById('sld_vw')
                          .classList.remove('open_sld'),
                      f_tggl_t(),
                      e.preventDefault()),
                  fldT.option('disabled') || (f_tggl_f(), e.preventDefault()),
                  e.target == lrt_fl.m && (lrt_fl.hide(), e.preventDefault()))
                : e.preventDefault()
        }
        function f_setup_gtiles() {
            if (
                ((tlg = document.getElementById('tlg')),
                !document.getElementById('tlg_editA'))
            ) {
                var div = document.createElement('div')
                ;(div.innerHTML =
            ...
            for (
                var fldtest = document.querySelectorAll('.tlg_fld'), i = 0;
                i < fldtest.length;
                i++
            )
            ...
            new Sortable(document.getElementById('edit_bin'), {
                ...
                onAdd: function (evt) {
                    var itemEl = evt.item
                    itemEl.parentNode.removeChild(itemEl),
                        (itemEl = evt.clone).parentNode.removeChild(itemEl),
                        (document.getElementById('edit_bin').style.background =
                            'transparent')
                },
                onChange: function (evt) {
                ...
                new Sortable(document.getElementById('edit_pencil'), {
                    ...
                    onAdd: function (evt) {
                        var itemEl, itemEl
                        f_etfg((itemEl = evt.clone)),
                            (itemEl = evt.item).parentNode.removeChild(itemEl),
                            (document.getElementById(
                                'edit_pencil'
                            ).style.background = 'transparent'),
                            f_evl_gtiles()
            ...
            const edit_b2 = document.getElementById('edit_bin2'),
                edit_p2 = document.getElementById('edit_pencil2'),
                edit_o2 = document.getElementById('edit_out2')
            ;(fldT = new Sortable(fldb, {
                group: { name: 'editM2', pull: 'clone' },
                swapThreshold: 0.45,
                invertSwap: !0,
                fallbackOnBody: !0,
                animation: 150,
    ...
    if (ntp_sett.status[2]) {
        ...
        function shouldIC() {
            const date1 = new Date(),
                date2 = new Date(localStorage.shouldIC)
            if (null == localStorage.shouldIC)
                return (localStorage.shouldIC = date1), !1
            const diffTime = Math.abs(date2 - date1),
                diffH = Math.ceil(diffTime / 36e5)
            return !(diffH < 30) && ((localStorage.shouldI = date1), !0)
        }
        function f_astd() {
            ...
            function f_ev_move(evt) {
                ...
                if (((el.style.transition = 'margin 0ms'), xDown)) {
                    var xUp = isTD ? evt.touches[0].clientX : evt.pageX
                    ;(xDiff = xDown - xUp),
                        (xDiff < 20 && xDiff > -20) ||
                            (xDiff < -20
                                ? (el.style.marginLeft = Math.abs(xDiff) + 'px')
                                : (el.style.marginLeft = '-' + xDiff + 'px'),
                            xDiff < 130 &&
                                xDiff > -130 &&
                                (el.style.opacity =
                                    '1' - Math.abs(xDiff) / 130))
                }
            }
            function f_ev_end(evt) {
                var el = evt.target.closest('div.news_item')
                xDiff > 130 || xDiff < -130
                    ? (el.parentNode.removeChild(el), fc_ns())
        ...
        function fc_ns() {
            if (
                void 0 === localStorage.cachedNewsUpdate ||
                Date.now() / 1e3 - localStorage.cachedNewsUpdate >= 0.1
            ) {
                const y = ntp_sett.order[2]
                ;(ntp_wdg[2].cached = document.getElementById(
                    'wdg_' + y
                ).innerHTML),
                    (localStorage.cachedNewsUpdate = Date.now() / 1e3),
                    console.log(
        ...
        function f_tnv() {
            '150px' == getComputedStyle(ntp_bdy).getPropertyValue('--o4')
        ...
        function f_nsrl(t) {
            ;(1 != t && 2 != t) ||
                ...
                2 == t && ntoast.success('Fetched news cleaned !')),
        ...
        function render_news_loading() {
            ;((loadingSVG = document.createElement('div')).id = 'loadingNW'),
        ...
        function add_gnews(title, news_time, source, source_logo, link, image) {
            ...
            if (
                ...
                var itemsNews = []
                localStorage.getItem('itemsNews') &&
                ...
                var innerDiv = document.createElement('div')
                ;(innerDiv.className = 'news_item'), (innerDiv.id = itemID)
                var imgrender = ''
                null != image &&
                    (imgrender =
                        '<img src="' +
                    ...
                    (innerDiv.innerHTML =
                        imgrender +
                        '<div class="news_cnt"><span class="news_attr"><img src="' +
                        source_logo +
                        '"/ alt="Article Image">&nbsp;&nbsp;&nbsp;<a href="' +
                        link +
                        '">' +
                        source +
                        '</a></span><div class="news_title"><a href="' +
                        link +
                        '">' +
                        title +
                        '</a></div><span class="news_time" data-time="' +
                        news_time.a +
                        '">' +
                        news_time.b +
                        '</span></a></div>'),
        ...
        function loadGNews() {
            if (
                (shouldIC() && document.getElementById('news').innerHTML,
                '' == document.getElementById('news').innerHTML ||
                    Date.now() / 1e3 - localStorage.cachedNewsUpdate > 3600 ||
                    forceReload)
            ) {
                ;(forceReload = !1),
        ...
        if (sel.options.length < 20)
            for (var el in locales) {
                ...
                opt.appendChild(document.createTextNode(el)),
                    ...
                    sel.appendChild(opt),
                    locales[el] == localStorage.newsLe && (opt.selected = !0)
            }
    ...
    function toggle_widget(i) {
        var y = ntp_sett.order[i],
            status = 1 == ntp_sett.status[i] ? 0 : 1
        console.log(
            ' Widget : ' +
                i +
                ' Order : ' +
            ...
            localStore('ntp_sett', ntp_sett),
            ntp_sett.status[i] && 1 == i && f_setup_gtiles(),
            ntp_sett.status[i] && 0 == i && f_setup_sb()
    }
    ...
    Sortable.create(document.getElementById('stt_lwo'), {
        ...
        onEnd: function (evt) {
            for (
                ...
                ;(ntp_sett.order[y] = z), (orderListChanged = 1)
            }
            load_widgets(),
                localStore('ntp_sett', ntp_sett),
                ntp_sett.status[0] && f_setup_sb(),
                ntp_sett.status[1] && f_setup_gtiles(),
                wait(100)
        }
    })
    const wDevice = window.innerWidth ? window.innerWidth : screen.width,
        hDevice = window.innerHeight ? window.innerHeight + 56 : screen.height,
        bg_pld = document.getElementById('bg_pld'),
    ...
    const wllp_file_l = document.getElementById('wllp_file_l'),
        wllp_file_d = document.getElementById('wllp_file_d')
    function random_gradient() {
        var colorOne = {
                R: Math.floor(255 * Math.random()),
                G: Math.floor(255 * Math.random()),
    ...
    function f_wallp1(a) {
        var file = 'l' == a ? wllp_file_l.files[0] : wllp_file_d.files[0]
        if (file && file.type.match('image.*')) {
            var reader = new FileReader()
            ;(reader.onload = function (e) {
                ;(bg_pld.style.display = 'none'),
                    '' == cr_img
                        ? ((cr_img = e.target.result), cropInit())
                        : ((cr_img = e.target.result), bindCropImg()),
    ...
    function f_wallp2() {
        ...
        ;(image.crossOrigin = 'Anonymous'),
            (image.onload = function (e) {
                ;(bg_pld.style.display = 'none'),
                    '' == cr_img
                        ? ((cr_img = image.src), cropInit())
                        : ((cr_img = image.src), bindCropImg()),
                    (crop.style.display = 'inline')
            }),
            (image.src = url)
    }
    ...
    function f_cp_mtc(a) {
        0 == a
            ? ((cp_current_el = 'mtcl'), picker.setColor(mtc.light, !0))
            : ((cp_current_el = 'mtcd'), picker.setColor(mtc.dark, !0)),
            cl_vn.show()
    }
    function f_cp_bg(a) {
        cp_current_el = 'bgc' + a
        let color = getComputedStyle(ntp_bdy).getPropertyValue('--bg-c' + a)
        picker.setColor(color, !0), cl_vn.show()
    }
    function f_cp_rgb(t) {
        ;(cp_current_el = t), (cp_type = 'clight')
        let color = getComputedStyle(ntp_bdy).getPropertyValue('--cl' + t)
        picker.setColor(color, !0), cl_vn.show()
    }
    function f_cpd_rgb(t) {
        ;(cp_current_el = t), (cp_type = 'cdark')
...
const tg_r77 = document.getElementById('tg_r77'),
    tg_r77vs = document.getElementById('tg_r77v')
...
const tg_r777 = document.getElementById('tg_r777'),
    tg_r777vs = document.getElementById('tg_r777v')
...
function gen(n) {
    return new Array(1024 * n + 1).join('a')
}
function set_maxSize() {
    ...
    if (!localStorage.getItem('ls_size')) {
        var i = 0
        try {
            for (i = 0; i <= 1e4; i += 250) localStorage.setItem('test', gen(i))
        } catch (e) {
...
function get_usedSize() {
    ...
    for (_x in localStorage)
        localStorage.hasOwnProperty(_x) &&
            (_lsTotal += _xLen = 2 * (localStorage[_x].length + _x.length))
    var total = (_lsTotal / 1024).toFixed(0)
    ;(document.getElementById('size_used').innerHTML = total),
        size_p.setAttribute('value', total)
}
null == ls_size
    ? (get_usedSize(), set_maxSize())
    : ((document.getElementById('size').innerHTML =
          localStorage.getItem('ls_size')),
      get_usedSize()),
