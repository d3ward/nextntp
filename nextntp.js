...
try {
    if (typeof window.chrome.embeddedSearch == 'undefined') {
        ...
        newsServer =
            'https://chromecontentsuggestions-pa.kiwibrowser.com/testnews/?'
    }
} catch (error) {
    newsServer =
        'https://chromecontentsuggestions-pa.kiwibrowser.com/testnews/?'
        ...
        K = {
            ...
            pluginEvent: function (e, n, o) {
                ...
                H.forEach(function (t) {
                    n[t.pluginName] &&
                        (n[t.pluginName][i] &&
                            n[t.pluginName][i](A({ sortable: n }, o)),
                ...
                if (
                    ...
                    if (
                        ...
                        if (
                            ...
                            return (
                                x(), a.insertBefore(q, m), (V = a), M(), O(!0)
                            )
...
!(function (e, t) {
    ...
    function C() {
        ...
        ;(this.options.useCanvas =
            this.options.enableOrientation || E.call(this)),
            (this.data = {}),
            (this.elements = {}),
            ...
            this.options.customClass &&
                d(this.element, this.options.customClass),
            function () {
                var e,
                    t,
                    o,
                ...
                function d(i) {
                    if (
                        ...
                        if (
                            ((l = !0), (e = i.pageX), (t = i.pageY), i.touches)
                        ) {
                            var o = i.touches[0]
                            ;(e = o.pageX), (t = o.pageY)
                        }
                ...
                function () {
                    ...
                    function n() {
                        _.call(e, {
                            ...
                            viewportRect:
                                e.elements.viewport.getBoundingClientRect(),
                    ...
                    d(t, 'cr-slider-wrap'),
                        ...
                        e.options.mouseWheelZoom &&
                            (e.elements.boundary.addEventListener(
                                'mousewheel',
                                o
                            ),
                            e.elements.boundary.addEventListener(
            ...
            new Promise(function (e, n) {
                switch (o.toLowerCase()) {
                    ...
                    case 'base64':
                        e(
                            function (e) {
                                return A.call(this, e).toDataURL(
                                    e.format,
                                    e.quality
                                )
                            }.call(t, i)
    ...
    function D(e) {
        ...
        ;(this.data.orientation =
            ...
            (i = e),
            (o = (n = a.indexOf(t) > -1 ? a : s).indexOf(t)),
            (r = (i / 90) % n.length),
            ...
            [
                {
                    key: 'printRGB',
                    value: function (e) {
                        var t = (e ? this.rgba : this.rgba.slice(0, 3)).map(
                            function (e, t) {
                                return a(e, 3 === t ? 3 : 0)
                            }
                        )
                ...
                },
                {
                    ...
                    value: function (e) {
                        var r = [360, 100, 100, 1],
                            i = ['', '%', '%', ''],
                            t = (e ? this.hsla : this.hsla.slice(0, 3)).map(
                                function (e, t) {
            ...
            n &&
                (function (e) {
                    if (e.startsWith('hsl')) {
                        ...
                        e.startsWith('#')
                            ? (f.rgba = g.hexToRgb(e))
                            : (f.rgba = g.nameToRgb(e) || g.hexToRgb(e))
                })(n.toLowerCase())
                    ...
                    value: function (r, i, n) {
                        this._events = this._events.filter(function (e) {
                            ...
                            return (
                                ...
                                i && i !== e.type && (t = !1),
                                n && n !== e.handler && (t = !1),
                                t && p._doRemove(e.target, e.type, e.handler),
                                !t
                            )
                        })
                    }
                ...
                },
                {
                    ...
                    value: function (e) {
                        ...
                        r &&
                            this.hide() &&
                            ((this.settings.parent.style.pointerEvents = ''),
                            t !== u && this.settings.parent.focus(),
                    ...
                    value: function () {
                        ...
                        var t = (function (e) {
                            ...
                            this.settings.template ||
                                '<div class="picker_wrapper" tabindex="-1"><div class="picker_arrow"></div><div class="picker_hue picker_slider"><div class="picker_selector"></div></div><div class="picker_sl"><div class="picker_selector"></div></div><div class="picker_alpha picker_slider"><div class="picker_selector"></div></div><div class="picker_sample"></div><div class="picker_editor"><input aria-label="Type a color name or hex value"/></div><div class="picker_cancel"><button onclick="f_close_cl()">Cancel</button></div><div class="picker_done"><button>Ok</button></div></div>'
                        )
                        return (
                            (this.domElement = t),
                            (this._domH = v('.picker_hue', t)),
                            (this._domSL = v('.picker_sl', t)),
                            (this._domA = v('.picker_alpha', t)),
                            (this._domEdit = v('.picker_editor input', t)),
                            (this._domSample = v('.picker_sample', t)),
                            (this._domOkay = v('.picker_done button', t)),
                            (this._domCancel = v('.picker_cancel button', t)),
                            t.classList.add('layout_' + this.settings.layout),
                            this.settings.alpha || t.classList.add('no_alpha'),
                            this.settings.editor ||
                                t.classList.add('no_editor'),
                            this.settings.cancelButton ||
                                t.classList.add('no_cancel'),
                ...
                },
                {
                    ...
                    value: function () {
                        this._events.destroy(),
                            this.domElement &&
                                this.settings.parent.removeChild(
                                    this.domElement
                                )
                    }
                },
                ...
                },
                {
                    ...
                    value: function (e, t, r, i, n) {
                        ...
                        ;[e, t, r, i].forEach(function (e, t) {
                            ...
                            (o.hsla = a),
                            this._updateUI(n),
                            this.onChange && !n.silent && this.onChange(o)
                    }
                },
                {
                    key: '_updateUI',
                    value: function (e) {
                        if (this.domElement) {
                            ...
                            k(0, l, r[0]),
                                (this._domSL.style.backgroundColor =
                                    this._domH.style.color =
                                        i),
                                k(0, c, r[1]),
                                _(0, c, 1 - r[2]),
                                (s.style.color = n),
...
if (wcentp) {
    ...
    function f_dwdg(i) {
        ...
        switch (i) {
            ...
            case 1:
                chd =
                    '<div id="tlg"> <div class="tlg_item folder"> <div class="tlg_img tlg_fld"></div><span id="tlg_span" class="tlg_title">Folder</span></div><div class="tlg_item"> <a id="tile_target" class="tile_target" href="https://kiwibrowser.com" rel="noreferrer"> <img class="tlg_img" src="https://logos.kiwibrowser.com/kiwibrowser.com" alt=""> <span id="tlg_span" class="tlg_title">Kiwi Browser</span> </a> </div></div>'
                break
            case 2:
                chd =
    ...
    console.log(
        '|' + getComputedStyle(ntp_bdy).getPropertyValue('--custom-font') + '|'
    )
    ...
    function render_se_list() {
        ...
        se_keys.forEach((el, index) => {
            ...
            if (se_icon != undefined) {
                ...
                var noshadow = ''
                if (se_icon[0] == '#ffffff') noshadow = 'box-shadow:none;'
                li.innerHTML =
    ...
    if (ntp_sett.status[0]) {
        ...
        function f_setup_sb() {
            ...
            document
                ...
                .addEventListener('focus', addShadow)
            document
                .getElementById('sb_input')
            ...
            Object.keys(ntp_sb.se).forEach((el, index) => {
                const se_status = ntp_sb.se[el]
                var se_icon = se_data_icons[el]
                if (se_icon == undefined) se_icon = ntp_sb.custom_se[el]
    ...
    if (ntp_sett.status[1]) {
        ...
        function f_cnf() {
            ...
            div.innerHTML =
                '<div class="tlg_img tlg_fld"></div><span id="tlg_span" class="tlg_title">' +
                ft_lab.value +
                '</span>'
            tlg.appendChild(div)
            f_evl_gtiles()
        ...
        document.getElementById('t_ac').onchange = function () {
            f_sac(this, 1)
        }
        document.getElementById('i_url').onpaste = function () {
            f_spti(this)
        }
        document.getElementById('i_url').onblur = function () {
            f_sptt(this)
        }
        document.getElementById('t_url').onkeyup = function () {
            f_sptt(this)
        }
        ...
        function f_attg(item) {
            ...
            innerDiv.innerHTML =
                '<a id="tile_target" class="tile_target" href="' +
                item.url +
                '" ' +
                targetBlank +
                ' rel="noreferrer">' +
    ...
    if (ntp_sett.status[2]) {
        ...
        function add_gnews(title, news_time, source, source_logo, link, image) {
            ...
            if (
                ...
                return
            var itemsNews = []
            if (localStorage.getItem('itemsNews'))
                itemsNews = JSON.parse(localStorage.getItem('itemsNews'))
    ...
    function toggle_widget(i) {
        ...
        document.getElementById('wdg_' + y).style.display = status
            ...
            : 'none'
        customInner(
            document.getElementById('wdg_' + y),
            status ? ntp_wdg[i].cached : ''
        )
        localStore('ntp_sett', ntp_sett)
    ...
    var bg_value_l = getComputedStyle(document.body).getPropertyValue(
        '--bg-img-l'
    )
    document.getElementById('wllp_value_l').value = bg_value_l
    var bg_value_d = getComputedStyle(document.body).getPropertyValue(
        '--bg-img-d'
    )
            ...
            if (
                ...
                if (cp_current_el == 'bgcl') {
                    ...
                    if (cp_current_el == 'mtcl') {
                        mtc.light = color.hex
                        document.getElementById('sett_mtc').style.background =
                            color.hex
                    } else {
                        mtc.dark = color.hex
                        document.getElementById('sett_mtc1').style.background =
                            color.hex
                    }
                    document
                        .querySelector('meta[name=theme-color]')
                        .setAttribute('content', color.hex)
                    localStorage.setItem('ntp_mtc', JSON.stringify(mtc))
                }
            }
            cl_vn.hide()
