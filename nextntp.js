...
//Font Changer
  ...
  var se_data_icons={
    ...
    "Yandex": ["#ffffff",'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 66" fill="#fff" fill-rule="evenodd" stroke="#000" stroke-linecap="round" stroke-linejoin="round"><use xlink:href="#a" x=".5" y=".5"/><symbol id="a" overflow="visible"><path d="M34 0l1 1-7 18-8 23a4 4 0 000 1v20l-2 1h-3l-1-1V43l-1-2L0 7V6h5l2 1 10 27v1l1-1 1-7 9-26 1-1h5z" stroke="none" fill="#e52620" /></symbol></svg>'],
    "Startpage": ["#6001D2",'<svg width="90.7" height="70" xmlns="http://www.w3.org/2000/svg"><g transform="translate(-7 -2) scale(.21938)" stroke-width="4.6"><text transform="matrix(16.2201 0 0 12.7232 -2507 -2745)" stroke="#000" font-family="\'Noto Sans JP\'" font-size="24" y="234.1" x="155.1" stroke-width="0" fill="#354473">S</text><text transform="matrix(17.6022 0 0 13.9754 -6750 -3828)" stroke="#000" font-family="\'Noto Sans JP\'" font-size="24" y="292.5" x="395.2" stroke-width="0" fill="#626ff7">p</text></g></svg>'],
    "Yahoo": ["#6001D2",'<svg role="img" fill="#fff" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Yahoo!</title><path d="M18.86 1.56L14.27 11.87H19.4L24 1.56H18.86M0 6.71L5.15 18.27L3.3 22.44H7.83L14.69 6.71H10.19L7.39 13.44L4.62 6.71H0M15.62 12.87C13.95 12.87 12.71 14.12 12.71 15.58C12.71 17 13.91 18.19 15.5 18.19C17.18 18.19 18.43 16.96 18.43 15.5C18.43 14.03 17.23 12.87 15.62 12.87Z"/></svg>'],
